...
export default function Home() {
  ...
  const suggestions = [
    { emoji: '🗄', title: 'Explore the database', description: 'See tables, schemas, and sample rows', query: 'What tables are available? Show me the schema.' },
    { emoji: '📈', title: 'Build a visualization', description: 'matplotlib, ggplot2, or interactive D3', query: 'Create a chart showing the most interesting trend' },
    { emoji: '🔬', title: 'Quick analysis', description: 'Summary stats and key insights', query: 'Give me a summary of the data with key statistics' },
    { emoji: '💡', title: 'Deep dive', description: 'Discover patterns and outliers', query: 'What are the top insights from this dataset?' },
  ]
